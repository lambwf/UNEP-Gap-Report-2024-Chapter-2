...
### Total net anthropogenic greenhouse gas emissions from 1990-2023

```{r total_figure,out.width="80%",fig.align = 'center',results='asis'}
cat("<br>")
include_graphics("results/figure_global_gases-1.png")

```
```{r total_links,results = 'asis'}

cat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Links: ")
cat("<a href='https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/UNEP-Gap-Report-2024-Chapter-2-Data-Global.xlsx'>data</a>|
    <a href='https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/figure_global_gases-1.png'>png</a>|
    <a href='https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/figure_global_gases-1.pdf'>pdf</a>")
```



### Total greenhouse gas emissions by sector in 2023

```{r sector_figure,out.width="80%",fig.align = 'center',results='asis'}
cat("<br>")
include_graphics("results/figure_global_sector_shares-1.png")
...
cat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Links: ")
cat("<a href='https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/UNEP-Gap-Report-2024-Chapter-2-Data-Global.xlsx'>data</a>|
    <a href='https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/figure_global_sector_shares-1.png'>png</a>|
    <a href='https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/figure_global_sector_shares-1.pdf'>pdf</a>")
```
...
filenames <- c("results/countries/United States.png",
               "results/countries/China.png",
               "results/countries/India.png",
               "results/countries/European Union.png",
               "results/countries/Russia.png",
               "results/countries/Brazil.png")
...
out <- lapply(seq_along(filenames), function(i) {
  ...
  country <- sub(".*/(.*)\\.png", "\\1", filenames[i])
  
  link_1 <- "<a href=\"https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/UNEP-Gap-Report-2024-Chapter-2-Data-Countries.xlsx\">data</a>"
  
  link_2 <- paste0("https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/countries/",country,".png")
  link_2 <- paste0("<a href=","\"",link_2,"\"",">png</a>")

  link_3 <- paste0("https://github.com/lambwf/UNEP-Gap-Report-2024-Chapter-2/results/countries/",country,".pdf")
  link_3 <- paste0("<a href=","\"",link_3,"\"",">pdf</a>")
...
filenames <- list.files("results/countries", pattern="*.png", full.names=TRUE)
...
### Data and file download

* <a href="https://zenodo.org/record/5053056">Zenodo data repository</a>
