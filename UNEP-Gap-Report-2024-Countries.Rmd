...
ggsave(wrap_elements(p1) / wrap_elements(p2) / wrap_elements(p3),filename = "figure_top_emitters_1.png",path = "results/",device = "png",height = 12,width=8.5,dpi=300)
ggsave(wrap_elements(p4) / wrap_elements(p5) / wrap_elements(p6),filename = "figure_top_emitters_2.png",path = "results/",device = "png",height = 12,width=8.5,dpi=300)
