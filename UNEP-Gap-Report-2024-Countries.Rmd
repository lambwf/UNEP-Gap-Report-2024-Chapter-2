...
data_indicators <- data_indicators %>% 
  ...
  mutate(co2_historic_fraction=signif(co2_historic_fraction*100,2)) %>% 
...
plot_country <- function(country_iso,data_ghg,data_crfs,data_indicators,pull_out_year) {
  ...
  indicator_text = paste0(data_countries$country[1]," released an estimated ",indicator_text$ghg_total[1]," MtCO2e in 2023 (excluding LULUCF), a change of ",indicator_text$change_rel[1]," % compared to the previous year. Per capita GHG emissions were ",indicator_text$ghg_per_capita[1], " tCO2e in 2023, while cumulative historic CO2 emissions were ",indicator_text$co2_historic[1]," GtCO2, representing about ",indicator_text$co2_historic_fraction[1], "% of global emissions to date.")
...
plot_country("BRA",data_ghg,data_crfs,data_indicators,2021)
plot_country("DEU",data_ghg,data_crfs,data_indicators,2021)
plot_country("AIA",data_ghg,data_crfs,data_indicators,2021)
plot_country("LBR",data_ghg,data_crfs,data_indicators,2021)
...
for (i in 1:length(countries$iso)) {
  ...
  ggsave(plot_country(countries$iso[i],data_ghg,data_crfs,data_indicators,2021),filename = paste0(countries$country[i],".png"),path = "results/countries",device = "png",height = 4,width=9,dpi=300)
  ggsave(plot_country(countries$iso[i],data_ghg,data_crfs,data_indicators,2021),filename = paste0(countries$country[i],".pdf"),path = "results/countries",device = "pdf",height = 4,width=9)
...
#   mutate(country="African Union")
# 
# plot_country("AU55",blarg,data_crfs,data_indicators,2021)
# 
