...
# 
#   #ggsave(plot_country(countries$iso[i],data_ghg,data_crfs,data_indicators,2023),filename = paste0(countries$country[i],".png"),path = "results/countries/",device = "png",height = 4,width=9,dpi=300)
#   ggsave(plot_country(countries$iso[i],data_ghg,data_crfs,data_indicators,2023),filename = paste0(countries$country[i],".png"),path = "results/countries/lowres/",device = "png",height = 4,width=9,dpi=150)
#   #ggsave(plot_country(countries$iso[i],data_ghg,data_crfs,data_indicators,2023),filename = paste0(countries$country[i],".pdf"),path = "results/countries/",device = "pdf",height = 4,width=9)
# 
# 
# }
